...
public class calcula {
    ...
    if (myCalc.esPrim(operand1)){
    System.out.println("El numero "+operand1+ " és primo");}
    else {
        System.out.println("El numero " + operand1 + " no es primo");}
    System.out.println("El nummero prim següent de " +operand1+ " es"+myCalc.proxPrim(operand1));
    }
}